...
<html lang="en">
  <head>
    ...
    <title>403 - Forbidden | Revenge Works</title>
    <meta name="description" content="Access to this area is forbidden. Please turn back or visit the homepage for more information.">
    ...
    <meta name="apple-mobile-web-app-title" content="Revenge Works">
    <meta name="application-name" content="Revenge Works">
  ...
  <body data-ip="<?php echo htmlspecialchars($ipAddress, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <h2 class="errortext">This Area Is Forbidden</h2>
    <h2 class="errortext ip-address">Your IP address: <?php echo htmlspecialchars($ipAddress, ENT_QUOTES, 'UTF-8'); ?></h2>
    <h3 class="errortext"><span><a href="/" title="Click To Visit Our Home Page">www.aeroseaspace.com</a></span></h3>
