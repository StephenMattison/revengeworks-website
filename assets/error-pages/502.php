...
<html lang="en">
  <head>
    ...
    <title>502 - Bad Gateway | Revenge Works</title>
    <meta name="description" content="The server received an invalid response from an upstream server. Please try again later or visit the homepage.">
  ...
  <body data-ip="<?php echo htmlspecialchars($ipAddress, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <h1 class="errorcode">ERROR 502</h1>
    <h2 class="errortext">Gateway Error - Please Retry</h2>
