...
<html lang="en">
  <head>
    ...
    <title>501 - Not Implemented | Revenge Works</title>
    <meta name="description" content="The requested functionality is not supported. Please contact the server administrator for more information.">
  ...
  <body data-ip="<?php echo htmlspecialchars($ipAddress, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <h1 class="errorcode">ERROR 501</h1>
    <h2 class="errortext">Requested Functionality Not Implemented</h2>
    <h3 class="errortext"><span><a href="/" title="Click To Visit Our Home Page">www.revengeworks.com</a></span></h3>
