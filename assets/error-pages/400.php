...
<html lang="en">
  <head>
    ...
    <title>400 - Bad Request | Revenge Works</title>
    <meta name="description" content="The request could not be understood by the server. Please try again or visit the homepage for more information.">
  ...
  <body data-ip="<?php echo htmlspecialchars($ipAddress, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <h1 class="errorcode">ERROR 400</h1>
    <h2 class="errortext">Your Request Is Invalid</h2>
