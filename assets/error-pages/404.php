...
<html lang="en">
  <head>
    ...
    <title>404 - Page Not Found | Revenge Works</title>
    <meta name="description" content="The page you are looking for does not exist. Please go back or visit the homepage for more information.">
  ...
  <body data-ip="<?php echo htmlspecialchars($ipAddress, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <h2 class="errortext">The Page You Seek Is Missing</h2>
