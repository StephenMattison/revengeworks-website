...
<html lang="en">
  <head>
    ...
    <title>504 - Gateway Timeout | Revenge Works</title>
    <meta name="description" content="The server took too long to respond. Please try again later or visit the homepage.">
  ...
  <body data-ip="<?php echo htmlspecialchars($ipAddress, ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <h1 class="errorcode">ERROR 504</h1>
    <h2 class="errortext">Bad Gateway - Please Retry</h2>
